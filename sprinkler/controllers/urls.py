...
urlpatterns = [
    ...
    path('sleep_now', device_command.sprinkle_off, name='sleep_now'),
    path('switch_broker_debug', device_command.sprinkle_off, name='switch_broker_debug'),
    path('switch_broker_prod', device_command.sprinkle_off, name='switch_broker_prod'),
